...
//Définition de la classe ListPageState, création d'une liste de taches instancié chacun avec un
...
//Création de la méthode _showFilterDialog qui permet de sélectionner les différents statuts des taches.
...
//cette méthode permet de filtrer les taches en fonction du statut séléctionné
  void _applyFilters() {
    setState(() {
...
//C'est la méthode qui permet de modifier une tache séléctionnée
...
//Cette méthode addTask permet d'ajouter une nouvelle tâche à la liste des taches présentes 
...
//Définition de la classe Item et du widget title
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'veuillez entrer une nouvelle tache' : null,
              ),
              SizedBox(height: 16),
              TextFormField(
                maxLines: 5,
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      TodoItem newTask = TodoItem(id: Uuid().v4(), title: title, indicatorColor: statusColor);
...
//widget qui permet de modifier une tache existante dans la la liste des taches
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Entrer une nouvelle tache' : null,
              ),
              SizedBox(height: 16),
              TextFormField(
                maxLines: 5,
                initialValue: 'Lorem ipsum dolor sit amet consectetur. Nisi nunc accumsan nisl lorem laoreet tempus faucibus pretium.',
                decoration: InputDecoration(
                  labelText: 'Description',
                  border: OutlineInputBorder(),
                ),
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      TodoItem updatedTask = TodoItem(id: widget.todo.id, title: title, indicatorColor: color);
...
//widget qui permet de'afficher le sélécteur de statut et qui va permettre 
//de choisir le statut qu'on veut associé à la tache
